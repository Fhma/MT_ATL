...
public class SingleRunATL {
	...
	public void run() {
		...
		// atl examples
		// String modelString =
		// SingleRunATL.class.getResource("resources/Book2Publication.xmi").getPath();
		// String modelString =
		...
		String modelString = SingleRunATL.class.getResource("resources/Table2SVGPieChart.xmi").getPath();
